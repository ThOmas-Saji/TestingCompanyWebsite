...
A modern, responsive company website built with React, TypeScript, Vite, and TailwindCSS. Features smooth animations, mobile-first design, and a comprehensive component library.
...
│   ├── SectionTitle.tsx # Section headers with badges
