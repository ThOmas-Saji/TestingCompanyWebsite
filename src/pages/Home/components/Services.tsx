          ...
          <div>
            <ul className="space-y-0">
              {services.map((service, index) => (
                <li
                  key={index}
                  className="flex items-center justify-between py-8 border-b border-gray-200/50 dark:border-white/10 cursor-pointer transition-all hover:pl-5 group"
                >
                  ...
                  <ArrowRight className="w-5 h-5 text-gray-600 dark:text-zinc-400 group-hover:text-emerald-400 group-hover:translate-x-2 transition-all" />
                </li>
              ))}
            </ul>
          </div>
