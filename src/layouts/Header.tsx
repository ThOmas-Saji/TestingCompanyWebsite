...
export function Header() {
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-10 flex justify-between items-center">
          ...
          <nav className="hidden md:flex items-center gap-10">
            ...
            <button
              ...
              className="text-white hover:text-emerald-400 font-medium uppercase tracking-colors"
            >
              Solutions
            </button>
            <button
      ...
      {/* Mobile Sidebar */}
      <div
        className={`fixed top-0 right-0 h-full w-80 bg-zinc-900/98 backdrop-blur-xl border-l border-white/8 z-50 transform transition-transform duration-300 ease-in-out md:hidden ${
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <nav className="flex-1 p-6 space-y-6">
            <button
              onClick={() => scrollToSection('home')}
              className="w-full text-left text-white hover:text-emerald-400 font-medium uppercase tracking-wide transition-colors py-3 border-b border-white/8 hover:border-emerald-400/50"
            >
              Home
            </button>
            <button
          ...
          <div className="p-6 border-t border-white/8">
            <Button
              onClick={() => scrollToSection('contact')}
              className="w-full bg-emerald-500 hover:bg-purple-600 text-white py-3 font-semibold uppercase tracking-wide transition-all hover:-translate-y-0.5"
            >
              Connect
            </Button>
          </div>
